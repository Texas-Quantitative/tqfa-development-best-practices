 ...
 * 
 * Usage:
 *   node extract-media-queries.mjs <url> [options]
 * 
 * Options:
 ...
 * 
 * Examples:
 *   node extract-media-queries.mjs https://example.com
 *   node extract-media-queries.mjs https://example.com --property margin-left
 *   node extract-media-queries.mjs https://example.com --selector .hero-section
 */
...
if (!url) {
    ...
    console.log('\nUsage: node extract-media-queries.mjs <url> [options]');
    console.log('\nOptions:');
